...
int main(void)
{
  ...
  while (1)
  {
	//uint32_t duty_r = (isr_count/32) % 100;
	//uint32_t duty_g = (isr_count/20) % 100;
	//uint32_t duty_b = (isr_count/10) % 100;

	if(flag > 0)
	{
		static float t = 0.0f;
		const float offset = M_TWOPI / 3.3f;
		const float half_arr = 50.0f;
